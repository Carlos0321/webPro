...
@Service //스프링에게 서비스임을 알려주는 어노테이션(빈 생성)
public class EmpServiceImpl implements EmpService {
	...
	public List<Emp> empList(String pageNum) {
		Paging paging = new Paging(empDao.totCnt(), pageNum,10,15);
		Emp emp = new Emp();
	...
	@Override
	public List<Emp> mangerList() {
		return empDao.mangerList();
	...
	public void dummyDataInsert50() {
		...
		for(int i= 5000; i<5050; i++) {
			...
			System.out.println(result ==1 ? i+"번쨰 성공" : i +"번째 실패 ");
		}
	}
