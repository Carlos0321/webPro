...
<body>
	...
	<form action="${conPath }/mvcboard/modify.do" method="post">
		...
		<table>
			...
			<tr><th>작성자</th><td><input type="text" name="bname" value="${bDto.bname }"></td></tr>
			<tr><th>글제목</th><td><input type="text" name="btitle" value="${bDto.btitle }"></td></tr>
			<tr><th>본문</th><td><textarea rows="5" cols="5" name="bcontent">${bDto.bcontent }</textarea></td></tr>
		<tr>
			<td colspan="2">
