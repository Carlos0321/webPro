...
<body>
	...
	<form action="${conPath }/modify.do" method="post">
		...
		<table>
			...
			<tr><th>작성자</th><td><input type="text" name="bname" value="${board.bname }"></td></tr>
			<tr><th>글제목</th><td><input type="text" name="btitle" value="${board.btitle }"></td></tr>
			<tr><th>본문</th><td><textarea rows="5" cols="5" name="bcontent">${board.bcontent }</textarea></td></tr>
		<tr>
			<td colspan="2">
