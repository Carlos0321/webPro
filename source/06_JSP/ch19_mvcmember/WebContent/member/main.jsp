...
<body>
	...
	<hr>
		...
		<table>
		<tr><td><button onclick="location.href='${conPath}/modifyView.do'">정보수정</button></td></tr>
		<tr><td><button onclick="location.href='${conPath}/logout.do'">로그아웃</button></td></tr>
		<tr><td><button onclick="location.href='${conPath}/allview.do'">전체회원보기</button></td></tr>
		</table>
	</c:if>
