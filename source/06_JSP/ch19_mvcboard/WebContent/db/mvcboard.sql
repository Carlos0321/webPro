...
CREATE TABLE BOARD (
    ...
    BSTEP NUMBER(6) NOT NULL , --그룹내 출력 순서
...
INSERT INTO BOARD (BID, BNAME,BTITLE,BCONTENT, BGROUP,BSTEP,BINDENT,BIP)
    ...
    --1번글의 답변  
    INSERT INTO BOARD (BID, BNAME,BTITLE,BCONTENT,BGROUP,BSTEP,BINDENT,BIP)
    VALUES (BOARD_SEQ.NEXTVAL,'답변','글1-1','답',1,1,1,'192.1.1.1');
--DAO에 들어갈 QUERY 
--글목록(startRow ~endRow)
...
--원글 쓰기
INSERT INTO BOARD (BID, BNAME,BTITLE,BCONTENT, BGROUP,BSTEP,BINDENT,BIP)
    VALUES (BOARD_SEQ.NEXTVAL, '민길동' ,'글3' , '-' , BOARD_SEQ.CURRVAL,0,0,'192.168.10.30');
--BID로 조회수 올리기 
