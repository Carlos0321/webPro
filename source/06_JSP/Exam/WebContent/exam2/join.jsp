...
<script>
	function chkJoin() {
		...
		if (!hobbycnt) {
			alert('취미를 하나 이상 선택하셔야합니다.');
			return false;
		}
		if(frmJoin.hobby[0].checked==false &&  
				 frmJoin.hobby[1].checked==false &&
				 frmJoin.hobby[2].checked==false &&
				 frmJoin.hobby[3].checked==false){
